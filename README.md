...
| 🛡️ **错误翻译** | 飞书 API 60+ 错误码精确到字段级别,自动指出"哪个参数、什么值、期望什么" |
| 🔑 **Token 自动续期** | 飞书 user_access_token 热更新 + 自动刷新 + refresh_token 过期引导重授权 |
| 🖼️ **图片生成** | 基于 Pollinations.ai 免费 API,支持自定义尺寸、种子、去水印 |
| 📚 **信源管理** | 可靠信源集合的 CRUD + 搜索,支持学术/技术/新闻等多类来源 |
