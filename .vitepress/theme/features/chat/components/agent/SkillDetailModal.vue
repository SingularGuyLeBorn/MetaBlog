...
const tabs = [
  { id: 'overview', label: '姒傝', icon: 'bar-chart' },
  { id: 'content', label: '鍐呭', icon: 'file-text' },
  { id: 'tools', label: '宸ュ叿', icon: 'tool' }
]
...
const metaItems = computed(() => [
  ...
  { label: '鐗堟湰', value: props.skill.version || '1.0.0' },
  { label: '浣滆€?, value: props.skill.author || 'System' },
  { label: '宸ュ叿鏁?, value: props.skill.tools?.length || 0 }
])
