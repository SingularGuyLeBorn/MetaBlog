...
<CardGroup cols={3}>
  <Card title="GLM-5" icon={<svg style={{maskImage: "url(/resource/icon/book-open.svg)", maskRepeat: "no-repeat", maskPosition: "center center",}} className={"h-6 w-6 bg-primary dark:bg-primary-light !m-0 shrink-0"}/>} href="/cn/guide/models/text/glm-5">
    **最新旗舰基座模型**
...
| 模型                                                          | 定位       | 特点                                                            | 上下文  | 最大输出 |
| :---------------------------------------------------------- | :------- | :------------------------------------------------------------ | :--- | :--- |
| [GLM-5](/cn/guide/models/text/glm-5)                        | 最新旗舰基座   | - 编程能力对齐Claude Opus 4.5<br />- 擅长 Agentic 长程规划与执行             | 200K | 128K |
